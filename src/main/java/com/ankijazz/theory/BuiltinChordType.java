...
public enum BuiltinChordType implements ScaleType {
  ...
  Major6(C6, "6", "1 3 5 6"),
  Major69(C69, "69", "1 3 5 6 9"),
  Major7(Cmaj7, "Δ7", "1 3 5 7"),
  Major9(Cmaj9, "Δ9", "1 3 5 7 9"),
  Major7Sharp11(Cmaj7Sharp11, "Δ7#11", "1 3 5 7 #11"),
  Major7Sharp5(Cmaj7Sharp5, "Δ7#5", "1 3 #5 7"),
  
  Minor7(Cm7, "m7", "1 b3 5 b7"),
  Minor6(Cm6, "m6", "1 b3 5 6"),
  Minor69(Cm69, "m69", "1 b3 5 6 9"),
  Minor9(Cm9, "m9", "1 b3 5 b7 9"),
  Minor11(Cm11, "m11", "1 b3 5 b7 11"),
  Minor7b5(Cm7b5, "m7b5", "1 b3 b5 b7"),
  Diminished7(Cdim7, "dim7", "1 b3 b5 bb7"),
  
  Dominant7(C7, "7", "1 3 5 b7"),
  Dominant9(C9, "9", "1 3 5 b7 9"),
  Dominant11(C11, "11", "1 3 5 b7 11"),
  Dominant13(C13, "13", "1 3 5 b7 13"),
  MinorMajor7(Cmmaj7, "mΔ7", "1 b3 5 7"),
  Dominant7sus4(C7sus4, "7sus4", "1 4 5 b7"),
  Dominant7flat9(C7flat9, "7b9", "1 3 5 b7 b9"),
  Dominant7sharp9(C7sharp9, "7#9", "1 3 5 b7 #9"),
  Dominant7flat5(C7flat5, "7b5", "1 3 b5 b7"), 
  Dominant7sharp5(C7sharp5, "7#5", "1 3 #5 b7"), 
  Dominant7sharp11(C7sharp11, "7#11", "1 3 5 b7 #11"), 
  Dominant7flat13(C7flat13, "7b13", "1 3 5 b7 b13"), 
  
  Dominant7flat5flat9(C7flat5flat9, "7b5b9", "1 3 b5 b7 b9"),
  Dominant7sharp5flat9(C7sharp5flat9, "7#5b9", "1 3 #5 b7 b9"),
  Dominant7flat5sharp9(C7flat5sharp9, "7b5#9", "1 3 b5 b7 #9"),
  Dominant7sharp5sharp9(C7sharp5sharp9, "7#5#9", "1 3 #5 b7 #9"),
  Dominant7flat9sharp11(C7flat9sharp11, "7b9#11", "1 3 5 b7 b9 #11"), // TODO: remove, not contained in any scale 
  Dominant7flat9flat13(C7flat9flat13, "7b9b13", "1 3 5 b7 b9 b13"),
  Dominant7sharp9sharp11(C7sharp9sharp11, "7#9#11", "1 3 5 b7 #9 #11"), // TODO: remove, not contained in any scale
  Dominant7sharp9flat13(C7sharp9flat13, "7#9b13", "1 3 5 b7 #9 b13"),
  
  MajorTriad(CmajTriad, "", "1 3 5"),
  MinorTriad(CminTriad, "m", "1 b3 5"),
  DiminishedTriad(CdimTriad, "dim", "1 b3 b5"),
  AugmentedTriad(CaugTriad, "aug", "1 3 #5"),
  Sus4Triad(Csus4Triad, "sus4", "1 4 5"),
  ...
  BuiltinChordType(Scale prototype, String typeName, String formula) {
   ...
   * Minor chords are notated using accidentals of relative (natural) minor scale.
   */
